...
public class Friend {
    ...
    public static String getColumns() {
        return "(friend_id, consumer_id, to_consumer_id, is_favorite, created_at, updated_at, deleted_at)";
    }
    ...
    public String getValues() {
        ...
        sb.append("(")
                ...
                .append(isFavorite ? "b'0'" : "b'1'").append(", ")
    ...
    public void swapConsumerId(Long friendId) {
        this.id = friendId;
